...
export const faqs = [
  {
    ...
    answer: 'The measure would fund Fire Department facilities, equipment, and emergency services. Eligible uses include fire stations, paramedic response, wildfire readiness, communications, and debt service for capital improvements. It also covers tax administration costs.',
    reference: 'Ordinance §§4.110.150 and 4.110.160',
  },
  {
  ...
  },
  {
    ...
    answer: 'The ordinance includes owners whose household income does not exceed the HUD very-low-income limit for the area, and owners who receive a senior citizen or disability utility-user-tax exemption. It also exempts government agencies and qualifying religious and community-service properties. The City administers eligibility.',
    reference: 'Ordinance §4.110.130',
  },
  {
    question: 'What accountability does the measure include?',
    answer: 'It requires an annual independent financial audit, a public annual report, and City Council oversight. Reports must include revenue, spending, capital-project status, and verification that the funds enhanced services above the established baseline. The ordinance names reconstruction of Fire Stations 33 and 37 within the first ten years.',
    reference: 'Ordinance §§4.110.150 and 4.110.190',
  },
  {
    question: 'Does it protect existing fire funding?',
    ...
    reference: 'Ordinance §§4.110.120 and 4.110.160',
  },
  {
    question: 'Why is the campaign asking for a NO vote?',
    answer: 'We support Pasadena’s firefighters and paramedics. We believe the City should develop a funding plan that shares the cost more broadly and gives residents a clearer picture of what they will pay.',
    reference: 'Campaign position',
  },
  {
    question: 'How does this affect rental housing?',
    answer: 'Rental properties are included in the tax on improved property, subject to applicable exemptions. Our campaign is concerned about the added cost of operating housing in Pasadena. The tax amount is not a prediction of a rent increase, and the measure does not itself authorize a direct rent pass-through.',
    reference: 'Ordinance §§4.110.130 and 4.110.170; campaign position',
  },
  {
    question: 'What does a NO vote do?',
    answer: 'A NO vote opposes this proposed parcel tax. The measure needs two-thirds approval to pass. Its defeat would not enact an alternative funding plan. We would ask City Hall to return with a proposal that shares the cost more broadly.',
    reference: 'Resolution 10203, §6; campaign position',
  },
];
